      ...
      {showCursorOverlay ? (
        ...
        >
          {mode === "dot" ? (
            ...
            <div className="flex items-center gap-2 rounded-full border border-black/10 bg-brand-paper px-4 py-2.5 text-[11px] font-semibold uppercase tracking-[0.12em] text-brand-ink shadow-lg sm:px-5 sm:text-xs">
